...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" DataSourceID="SqlDataSource1" Height="350px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" Width="748px" AutoGenerateDeleteButton="True">
        <Columns>
            ...
            <asp:ButtonField ButtonType="Button" CommandName="Delete" HeaderText="신청취소" ShowHeader="True" Text="취소" />
        </Columns>
    </asp:GridView>
